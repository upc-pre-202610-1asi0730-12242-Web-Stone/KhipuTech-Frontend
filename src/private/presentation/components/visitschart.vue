  ...
  <div class="card">
    <div class="card-header">
      ...
      <div class="export-buttons">
        <button @click="$emit('export-excel')" class="export-btn excel">📊 Excel</button>
        <button @click="$emit('export-pdf')" class="export-btn pdf">📄 PDF</button>
      </div>
    </div>
    ...
    <div class="chart-stats">
      <div class="chart-stat"><span>Pico máximo:</span> <strong>{{ maxVisitas }} visitas</strong></div>
      <div class="chart-stat"><span>Promedio por hora:</span> <strong>{{ promedioVisitas }}</strong></div>
    </div>
  </div>
</template>
