  ...
  <div class="card">
    <div class="card-header">
      ...
      <div class="export-buttons">
        <button @click="$emit('guardar-config')" class="export-btn">💾 Guardar config</button>
        <button @click="$emit('exportar-pdf')" class="export-btn pdf">📄 Exportar PDF</button>
        <button @click="$emit('exportar-excel')" class="export-btn excel">📊 Exportar Excel</button>
      </div>
    </div>
...
.mapa-card.normal .estado-text {
  color: #27ae60;
}

.mapa-card.moderada .estado-text {
  color: #f39c12;
}

.mapa-card.critica .estado-text {
  color: #e74c3c;
}
